    ...
    <>
      <Tabs.Root defaultValue="제출한 지원서" className="w-full py-[1.6rem]">
        ...
        <Tabs.Content value="받은 지원서">
          {studies.map((study) => (
            <div className="bg-gray-100 px-[1.6rem] flex flex-col py-[2rem]">
              <div className="bg-white w-full flex flex-col gap-[1.6rem] px-[2rem] py-[2.4rem] rounded-[0.8rem] border border-gray-300">
